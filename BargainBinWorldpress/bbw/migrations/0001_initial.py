    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbw.post')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbw.siteuser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbw.post')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbw.tags')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(through='bbw.PostTags', to='bbw.tags'),
        ),
        migrations.CreateModel(
            name='CommentUpdoots',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_updoot', models.BooleanField(default=True, editable=False)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbw.comment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bbw.siteuser')),
            ],
            options={
                'abstract': False,
